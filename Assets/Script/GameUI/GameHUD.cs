...
namespace Tundayne.UI
{
    public class GameHUD : UIElement
    {
        ...
        public override void Tick(float delta)
        {
            ...
            //Vector3 tp = (isLeftPivot.value) ? normalPosition_left.localPosition : normalPosition_right.localPosition;
            //Quaternion tr = (isLeftPivot.value) ? normalPosition_left.localRotation : normalPosition_right.localRotation;
